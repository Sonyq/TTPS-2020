          ...
          <div class="md-layout">
            ...
            <div class="md-layout-item md-small-size-100 md-size-50">
              ...
              >
                ...
                <div
                  v-show="tacToraxTipo == 'patológico'"
                  class="md-layout-item md-small-size-50 md-size-90"
                >
              ...
              >
                ...
                <div
                  v-show="pcrCovidTipo == 'patológico'"
                  class="md-layout-item md-small-size-50 md-size-90"
                >
            ...
            <div class="md-layout">
              ...
              <div class="md-layout-item md-size-50 text-right">
                <md-button class="md-raised md-success" @click="submit()"
                  >Guardar</md-button
                >
              </div>
            </div>
